...
<form id="frmPost">
    <div class="form-group">
        <label>Title:</label>
        <input type="hidden" id="idInput" value="{{ $post->id }}" name="id">
    ...
    <div class="form-group">
        <label>Status:</label>
        <label class="radio-inline"><input type="radio" name="status" value="1" @if (1 == $post->status) checked @endif  >Active</label>
        <label class="radio-inline"><input type="radio" name="status" value="0" @if (0 == $post->status) checked @endif >Deactive</label>
        <span class="help-block hidden"></span>
    </div>
